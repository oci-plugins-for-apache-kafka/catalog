...
| [Debezium connectors](https://github.com/oci-plugins-for-apache-kafka/catalog/tree/main/plugins/debezium-connectors) | `ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-cassandra-3`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-cassandra-4`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-cassandra-5`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-cockroachdb`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-db2`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-dse`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-ibmi`<br>`ghcr.io/oci-plugins-for-apache-kafka/debezium-connectors:3.5.2.Final-informix`<br>... and 10 more | [Upstream](https://github.com/debezium/debezium) |
| [Kafka Connect plugin which logs messages into log](https://github.com/oci-plugins-for-apache-kafka/catalog/tree/main/plugins/echo-sink) | `ghcr.io/oci-plugins-for-apache-kafka/echo-sink:1.6.0` | [Upstream](https://github.com/scholzj/echo-sink) |
